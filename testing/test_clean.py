...
def test_headers_to_snakecase_is_lower(sample_dataframe):
    ...
    '''
    df = sample_dataframe
    df = dpypr.clean.headers_to_snakecase(df)
...
def test_headers_to_snakecase_is_upper(sample_dataframe):
    ...
    '''
    df = sample_dataframe
    df = dpypr.clean.headers_to_snakecase(df, uppercase = True)
...
def test_values_to_lowercase(sample_dataframe):
    ...
    '''
    df = sample_dataframe
    df = dpypr.clean.values_to_lowercase(df)
...
def test_values_to_uppercase(sample_dataframe):
    ...
    '''
    df = sample_dataframe
    df = dpypr.clean.values_to_uppercase(df)
