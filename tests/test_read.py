...
def test_read_everything_reads_correct_files(tmp_path, df_sample):
    ...
    # assert data_dictionary['df_test_3_excel'].equals(df)
    # assert data_dictionary['df_test_4_feather'].equals(df)
    # assert data_dictionary['df_test_5_parquet'].equals(df)
    # assert data_dictionary['df_test_6_pickle'].equals(df)
    # del data_dictionary
